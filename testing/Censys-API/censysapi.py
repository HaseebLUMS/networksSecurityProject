...
IPV4_FIELDS = ['21.ftp.banner.banner', '23.telnet.banner.banner', '80.http.get.body']
...
for d in data:
    ...
    #     pass
    try:
        banners[i] = {'banner': d['80.http.get.body'], 'protocol': 'HTTP'}
        i += 1
    except:
        print('no http')
        pass
...
with open('bannersHTTP.json', 'w') as f: f.write(banners)